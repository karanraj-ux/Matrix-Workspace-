...
export const EmailReader: React.FC<EmailReaderProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black/80 backdrop-blur-sm flex flex-col justify-end md:justify-center items-center p-0 md:p-6 animate-in fade-in duration-200">
      <div className="w-full h-[90vh] md:h-[85vh] md:max-w-4xl bg-white rounded-t-2xl md:rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-in slide-in-from-bottom-full md:zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between p-4 border-b border-neutral-100 bg-neutral-50 shrink-0">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h3 className="font-bold text-sm text-neutral-900 truncate">{activeEmail.subject}</h3>
          ...
          <button onClick={() => setActiveEmail(null)} className="p-2 hover:bg-neutral-200 rounded-full transition-colors text-neutral-500 shrink-0 ml-2">
            <X size={20} />
          </button>
        </div>
        ...
        {/* Triage Actions */}
        <div className="p-4 bg-neutral-50 border-t border-neutral-100 grid grid-cols-3 gap-2 shrink-0 pb-safe">
          <button 
            onClick={() => executeEmailAction('archive')}
            className="flex flex-col items-center justify-center gap-1 py-3 px-2 bg-neutral-200 hover:bg-neutral-300 text-neutral-800 rounded-xl font-medium transition-colors"
          >
            <Archive size={18} />
          ...
          <button 
            ...
            className="flex flex-col items-center justify-center gap-1 py-3 px-2 bg-black hover:bg-neutral-800 text-white rounded-xl font-medium transition-colors"
          >
            <Reply size={18} />
